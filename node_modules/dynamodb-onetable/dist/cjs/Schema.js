...
class Schema {
    ...
    */
    ...
    createUniqueModel() {
        ...
        this.uniqueModel = new Model_js_1.Model(table, UniqueModel, { fields, timestamps: false });
    }
    /*
    ...
    createGenericModel() {
        ...
        this.genericModel = new Model_js_1.Model(table, GenericModel, { fields, timestamps: false, generic: true });
    }
    createSchemaModel() {
        let { indexes, schema, table } = this;
        let primary = indexes.primary;
        ...
        this.models[SchemaModel] = new Model_js_1.Model(table, SchemaModel, { fields });
    }
    ...
    addModel(name, fields) {
        this.models[name] = new Model_js_1.Model(this.table, name, { indexes: this.indexes, fields });
    }
    listModels() {
