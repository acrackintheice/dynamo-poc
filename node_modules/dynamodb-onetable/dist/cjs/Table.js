...
class Table {
    ...
    */
    ...
    execute(model, op, cmd, params = {}, properties = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let mark = new Date();
            ...
            try {
                ...
                if (params.throw === false) {
                    ...
                    throw new Error_js_1.OneError(`Conditional create failed for "${model}`, { code: 'Condition' });
                }
                else {
                    result = result || {};
                    result.Error = 1;
    ...
    */
    ...
    batchWrite(batch, params = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.execute(GenericModel, 'batchWrite', batch, params);
        });
    }
