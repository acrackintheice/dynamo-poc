    ...
    run(op, expression) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            ...
            let result;
            do {
                result = yield this.table.execute(this.name, op, cmd, params, properties);
    ...
    createUnique(properties, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let field of fields) {
                ...
                let sk = '_unique#';
                yield this.schema.uniqueModel.create({ pk, sk }, { transaction, exists: false, return: 'NONE' });
            }
    ...
    */
    removeUnique(properties, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let field of fields) {
                let pk = `_unique#${this.name}#${field.attribute}#${properties[field.name]}`;
                let sk = `_unique#`;
                yield this.schema.uniqueModel.remove({ pk, sk }, { transaction });
            }
    ...
    updateUnique(properties, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            let prior = yield this.get(properties);
            if (prior) {
            ...
            for (let field of fields) {
                ...
                if (prior && prior[field.name]) {
                    ...
                    */
                    ...
                    yield this.schema.uniqueModel.remove({ pk: priorPk, sk }, { transaction, exists: null });
                }
                yield this.schema.uniqueModel.create({ pk, sk }, { transaction, exists: false, return: 'NONE' });
            }
    ...
    */
    ...
    validateProperties(op, fields, properties, params) {
        ...
        if (Object.keys(details).length > 0) {
            ...
            let err = new Error_js_1.OneError(`Validation Error for "${this.name}"`, { validation: details, code: 'Validation' });
            //  DEPRECATE
            err.details = details;
            throw err;
        }
