...
export class OperationItem {
  ...
  constructor(data: NonFunctionProperties<OperationItem>) {
    this.pk = data.pk;
    this.sk = data.sk;
  ...
  static fromDynamoItem(dynamoItem: DocumentClient.AttributeMap): OperationItem {
  ...
  static fromDomain(country: Country): OperationItem {
